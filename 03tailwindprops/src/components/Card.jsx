...
function Card({userName, btnText="follow us"}) {
  ...
  return (
    <div>Card
      ...
      <div className="flex flex-col py-3 px-3 pb-7 -mt-4 bg-black rounded-b-xl ">
        ...
        <button className="bg-white text-black py-2 px-4 rounded-lg mt-2 hover:bg-gray-200 transition duration-300">{btnText}</button>
